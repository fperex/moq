...
- **Containers**: `Container.Legacy` producer/consumer and `Container.Cmaf` init and data segment helpers, plus `Container.Jitter`, the [playout target estimator](/concept/playout) a receiver sizes its audio buffer from.
