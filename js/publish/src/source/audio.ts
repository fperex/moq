...
/** The presentation the decoded samples are rendered onto. */
 ...
 *
 * The silence matches the first decoded sample, not the container's metadata: an AAC extension
 * decodes to a different rate and channel layout than the track declares.
 */
